...
class GPTZero(object):
    ...
    def __call__(self, sentence):
        ...
        results["perplexity"] = self._get_perplexity(sentence)
        perplexity_per_line = self._get_PPL(lines)
        ...
        verdict, label = self._get_results(results["avg_ppl"])
        results["label"] = label
